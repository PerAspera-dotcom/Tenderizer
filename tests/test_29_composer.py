...
def test_run_composer_generate_persists_results_and_writes_docx(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(composer, "run_generate", lambda tenant_id, pub_number, requirements, style_guide=None, top_k=None, good_similarity=None, partial_similarity=None, vault_doc_ids=None, valid_until_by_doc_id=None: [
